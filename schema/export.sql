...
--
-- Host: 127.0.0.1    Database: housemates
-- ------------------------------------------------------
...
CREATE TABLE `actions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `actions_id_uindex` (`id`)
...
CREATE TABLE `responses` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `responses_id_uindex` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usermeta` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `usermeta_id_uindex` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-12 23:20:24
